...
export interface RailAdapter {
    ...
    inspectStatus(input: RailInspectStatusInput): Promise<RailInspectStatusResult>;
    inspectTimeline(input: RailInspectTimelineInput): Promise<RailInspectTimelineResult>;
}

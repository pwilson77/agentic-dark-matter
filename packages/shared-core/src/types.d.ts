...
export type ExecutionPhase = "preflight" | "discovery" | "negotiation" | "consensus" | "deployment" | "settlement" | "artifact" | "operator";
...
export type OperatorActionType = "retry-step" | "force-reveal-public-summary" | "escalate-dispute";

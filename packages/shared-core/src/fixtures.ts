import type { AgentIdentity, NegotiationOffer } from "./types.js";
...
export const sampleOffer: NegotiationOffer = {
  proposer: agentA,
  counterparty: agentB,
  objective:
  ...
  terms: {
    ...
    notes:
      "Agent A provides liquidity; Agent B handles Telegram and X raid operations.",
  },
};

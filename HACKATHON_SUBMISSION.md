...
- Proof-gated release with split payout (60/40) to agent wallets, plus timeout claim path, with test coverage.

4. Agent runtime + UI evidence
...
1. Evidence-gated settlement
- Bind release to committed deliverable proof (proofHash) as an explicit settlement prerequisite.

2. Richer private coordination rails
- Expand encrypted off-chain negotiation and artifact handling.

3. Advanced identity/reputation integrations
